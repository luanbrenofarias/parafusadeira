...
const imagens = ["./assets/media/prod01.avif", "./assets/media/prod02.avif", "./assets/media/prod03.avif", "./assets/media/prod04.avif", "./assets/media/prod05.avif", "./assets/media/prod06.avif", "./assets/media/prod07.avif"];
let imagemAtual = 0;
let touchStartX = 0;
let touchEndX = 0;
...
var messages = ["Aproveite 🔥", "Baixou 48%"];
